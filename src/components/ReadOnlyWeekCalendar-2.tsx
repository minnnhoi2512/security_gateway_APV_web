...
const ReadOnlyWeekCalendar2: React.FC<ReadOnlyMonthCalendarProps> = ({
  daysOfSchedule = "",
  expectedStartTime,
  expectedEndTime,
}) => {
  ...
  const convertStartDate = startDate ? dayjs(startDate).format("DD/MM/YYYY") : '';
      ...
      <div>
        <div className="flex flex-col">
          ...
          <DatePicker
            ...
            format={"DD/MM/YYYY"}
            value={convertStartDate ? moment(convertStartDate, "DD/MM/YYYY") : null}
            disabled
...
export default ReadOnlyWeekCalendar2;
