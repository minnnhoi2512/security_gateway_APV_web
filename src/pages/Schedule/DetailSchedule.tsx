...
const DetailSchedule = ({ scheduleId, onUpdateSuccess }: any) => {
  ...
  return (
    <div className="flex justify-center items-center p-4">
        <Form form={form} layout="vertical" onFinish={handleFinish} className="grid grid-cols-3 gap-6">
          <div className="col-span-2 space-y-4">
            <Form.Item
              label={<span className="text-blue-500 font-semibold text-lg">Tiêu đề</span>}
              name="scheduleName"
              rules={[
            ...
            >
              <Input placeholder="Nhập tiêu đề dự án" className="rounded-md" />
            </Form.Item>

            <Form.Item
              label={<span className="text-blue-500 font-semibold text-lg">Trạng thái</span>}
              name="status"
            ...
            <Form.Item
              label={<span className="text-blue-500 font-semibold text-lg">Miêu tả</span>}
              name="description"
              rules={[
            ...
            >
              <Editor
                ...
                editorClassName="p-4 h-32 rounded-md focus:outline-none"
              />
            </Form.Item>
          </div>

          <div className="col-span-1 space-y-4">
  <Form.Item label={<span className="text-blue-500 font-semibold text-lg">Loại lịch trình</span>}>
    {renderScheduleTypeTag(scheduleData?.scheduleType?.scheduleTypeName)}
  </Form.Item>
  {isProcessWeek && (
  <div>
    <h2 className="text-lg text-gray-600 font-semibold">Chọn Thứ cho Lịch trình</h2>
        ...
        <div
          ...
          className={clsx(
            "flex items-center justify-center w-12 h-10 rounded-full cursor-pointer transition-all duration-200",
            {
              ...
              "border-2 border-transparent hover:border-purple-600": true, // Add consistent border effect
            }
          )}
...
{isProcessMonth && (
  <div>
    <h2 className="text-lg text-gray-600 font-semibold">Chọn Ngày cho Lịch trình</h2>
